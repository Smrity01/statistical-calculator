...
cm <- multiple_regression(x1,x2,y)
...
discete_distribution <- function(){
  ...
  while(answer=='yes'){
    ...
    if (choice1==1){
      ...
      cat('\n Discrete Uniform Distribution pdf : ',dud)
    }
      ...
      cat('\n \n Discrete Bernoulli Distribution : ',dbd)
    }
      ...
      cat('\n \n Discrete Binomial Distribution : ',dbd)
    }
      ...
      cat('\n \n Discrete Geometric Distribution : ',dgd) 
    }
      ...
      cat('\n \n Discrete HyperGeometric Distribution : ',dhg)
    }
      ...
      cat('\n \n Discrete Negative Binomial Distribution : ',dnb)
    }
      ...
      cat('\n \n Discrete Poisson Distribution : ',dpd)
    }
      ...
      cat('\n \n Discrete Multinomial Distribution : ',dmd)
    }
      ...
      cat('\n \n Discrete Multivariate Hypergeometric Distribution : ',dmh)
    }  
...
Interval_estimation<-function(){
  ...
  while(answer=='yes'){
    ...
    cat('\n ----------INTERVAL ESTIMATION---------')
    #cat('\n*****ENTER YOUR CHOICE*****')
    cat('\n 1.Estimation of Mean \n 2.Estimation of mean difference \n 3.Estimation of proportion \n 4.Estimation of proportion difference \n 5.Estimation of variance 6.Estimation of variance difference \n ')
    choice1 <- readline(prompt = 'ENTER YOUR CHOICE: ')
    ...
    if (choice1==1){
      ...
      print('\n *****Estimation of variance difference*****')
      n1 <- as.numeric(readline(prompt = "Enter the first sample size: "))
      variance1 <- as.numeric(readline(prompt = "Enter the first sample variance: "))
      n2 <- as.numeric(readline(prompt = "Enter the second sample size: "))
      ...
      cat("confidence interval for population variance is:",eov[1],'< population_mean <',eov[2])
...
test_statistic<-function(){
  ...
  while(answer=='yes'){
    ...
    answer<-readline(prompt = '\n Do you want to continue with predictive analysis (yes/no): ')
